...
typedef std::string STMT_NO, PROG_LINE, VAR_NAME, PROC_NAME, CONST_VAL, STMT_TYPE, STMT_REF;
...
typedef std::unordered_set <std::vector<std::string>, VectorHash> DOUBLE_COL_TABLE;